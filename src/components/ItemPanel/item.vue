<template>
  <el-collapse v-model="activeNames">
    <el-collapse-item class="collapse-title" title="流量节点" name="baseNode">
      <ul>
        <li
    ...
    <el-collapse-item class="collapse-title" title="基本节点" name="activitiNode">
      <ul>
        <li
    ...
    <el-collapse-item class="collapse-title" title="控制节点" name="jarNode">
      <ul>
        <li
  ...
  methods: {
    ...
    checkMultiNode(item) {
      ...
      for (let index in nodes) {
        ...
        if ( node.activityNodeType == item.activityNodeType && (item.activityNodeType == "startNode" || item.activityNodeType == "endNode") ) {
          hasMore = true;
        }
      }
      return hasMore;
